...
import { HA_HOSTNAME } from './client';
import { isHaConfigured, setHaReprovision, haSubscribeEvents } from './client';
import { haBootstrap } from './bootstrap';
...
export function setupHaEventSync(
...
export async function onBoot(): Promise<void> {
